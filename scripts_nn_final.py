...
te_all = [TESpec((c,), m=10) for c in OTHER + DIG] + [TESpec((INC,), m=10, binwidth=1000)]
...
seed = int(sys.argv[1])
run(f"nnF_k20_s{seed}", full, te_specs=te_multi + te_all, model="nn", params={**E9, "seed": seed}, static_version="v2", n_folds=20,
    ref="nn_E9_k20_s0")
